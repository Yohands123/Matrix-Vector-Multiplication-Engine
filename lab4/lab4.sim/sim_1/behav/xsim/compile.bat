...
REM
REM Generated by Vivado on Mon Jul 13 12:47:19 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj mvm_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj mvm_tb_vlog.prj -log xvlog.log
